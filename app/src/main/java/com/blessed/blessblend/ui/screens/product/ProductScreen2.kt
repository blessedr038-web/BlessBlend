...
import com.blessed.blessblend.navigation.ROUTE_FINALE2
...
@Composable
fun ProductScreen2(navController: NavController) {
    var selectedIndex by remember { mutableStateOf(0) }

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Medium Skin", fontWeight = FontWeight.Bold) },
                navigationIcon = {
        ...
        Column(
            ...
            Column(
                ...
                Button(
                    onClick = {
                        navController.navigate(ROUTE_FINALE2)
                    },
...
@Composable
fun ProductScreen2Preview() {
    ProductScreen2(rememberNavController())
}