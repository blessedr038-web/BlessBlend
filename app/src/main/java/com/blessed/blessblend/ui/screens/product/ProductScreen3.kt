...
import com.blessed.blessblend.navigation.ROUTE_FINALE3
...
@Composable
fun ProductScreen3(navController: NavController) {
    var selectedIndex by remember { mutableStateOf(0) }

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Tan Skin", fontWeight = FontWeight.Bold) },
                navigationIcon = {
        ...
        Column(
            ...
            Column(
                ...
                Button(
                    onClick = {
                        navController.navigate(ROUTE_FINALE3)
                    },
...
@Composable
fun ProductScreen3Preview() {
    ProductScreen3(rememberNavController())
}