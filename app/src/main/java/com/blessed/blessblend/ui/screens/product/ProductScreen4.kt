...
import com.blessed.blessblend.navigation.ROUTE_FINALE4
...
@Composable
fun ProductScreen4(navController: NavController) {
    var selectedIndex by remember { mutableStateOf(0) }

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Deep Skin", fontWeight = FontWeight.Bold) },
                navigationIcon = {
...
// --- FIXED BUTTON ---
                Button(
                    onClick = {
                        navController.navigate(ROUTE_FINALE4)
                    },
...
@Composable
fun ProductScreen4Preview() {
    ProductScreen4(rememberNavController())
}